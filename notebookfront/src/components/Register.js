    ...
    const handleSubmit = (e) => {
        ...
        if (
            ...
            if (
                ...
                //daca exista utilizatorul respectiv sa nu mai fie nevoie sa se inregistreze din nou
                //si sa ii ramana datele salvate din folosirea app anterioare
                console.log(user);
        ...
        return (
            <div className="register-form">
                <form onSubmit={handleSubmit}>
                    ...
                    <br />
                    {validateEmail && (
                        <h6>Email must contain "@stud.ase.ro" domain</h6>
                    )}
                    ...
                    {validateRegister && (
                        <h6>
                            Please complete all fields for registering domain
                        </h6>
                    )}
                    <br />
                    <input
